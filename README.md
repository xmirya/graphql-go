# graphql-go [![Sourcegraph](https://sourcegraph.com/github.com/xmirya/graphql-go/-/badge.svg)](https://sourcegraph.com/github.com/xmirya/graphql-go?badge) [![Build Status](https://semaphoreci.com/api/v1/graph-gophers/graphql-go/branches/master/badge.svg)](https://semaphoreci.com/graph-gophers/graphql-go) [![GoDoc](https://godoc.org/github.com/xmirya/graphql-go?status.svg)](https://godoc.org/github.com/xmirya/graphql-go)
...
This fork is created to inject the ability of passing a query subtree to every resolver, so resolvers may perform different kinds of optimizations like mass record prefetching.
...
We're trying out the GitHub Project feature to manage `graphql-go`'s [development roadmap](https://github.com/xmirya/graphql-go/projects/1).
...
import (
        ...
        graphql "github.com/xmirya/graphql-go"
        "github.com/xmirya/graphql-go/relay"
)
